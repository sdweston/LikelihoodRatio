...
sql1="select t1.cid,t1.swire_index_spitzer,t2.swire_index_spitzer,t1.lr,t1.reliability,t2.r_arcsec \
      from atlas.ecdfs_matches t1, atlas.nn_ecdfs_matches t2 \
      where t1.cid=t2.cid \
...
#------------------------------------------------------------------------------
    ...
    postage_stamp_filename1='d:\\elaiss1\\dr3\\lr_vs_nn\\atlas_'+cid1+'.jpeg'
...
#    print cmd1
    ...
    postage_stamp_filename='d:\\elaiss1\\dr3\\\\lr_vs_nn'+cid1+'_'+swire_id+'_'+ra_radio1+'_'+dec_radio1+'.jpeg'
