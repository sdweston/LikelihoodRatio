...
--
-- Table structure for table `elais_cmpcat_24nov2014`
--

DROP TABLE IF EXISTS `elais_cmpcat_24nov2014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elais_cmpcat_24nov2014` (
...
-- Dump completed on 2014-12-01 18:55:34
