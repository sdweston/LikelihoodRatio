...
--
-- Table structure for table `elais_cmpcat_17june2014`
--

DROP TABLE IF EXISTS `elais_cmpcat_17june2014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `elais_cmpcat_17june2014` (
  `ID` varchar(8) NOT NULL COMMENT 'Component identification number',
  `Name1` varchar(6) DEFAULT NULL COMMENT 'Full catalogue name',
  `Name2` varchar(20) DEFAULT NULL COMMENT 'Component name',
...
-- Dump completed on 2014-12-01 18:55:54
