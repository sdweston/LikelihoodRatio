...
--
-- Table structure for table `old_cdfs_cmpcat_24nov2014`
--

DROP TABLE IF EXISTS `old_cdfs_cmpcat_24nov2014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `old_cdfs_cmpcat_24nov2014` (
  ...
  `SNR` double DEFAULT NULL COMMENT 'signal-to-noise ratio of raw dectection',
...
-- Dump completed on 2014-12-01 18:55:46
