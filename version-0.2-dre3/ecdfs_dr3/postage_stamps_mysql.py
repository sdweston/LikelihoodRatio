...
db.query("select t1.cid,t1.swire_index_spitzer,t2.ra_deg,t2.dec_deg,t1.reliability \
          from atlas.ecdfs_matches as t1, atlas.atlasdr3_fullcmpcat as t2 \
...
#------------------------------------------------------------------------------
    ...
    contour_file_name='d:\\ecdfs\\dr3\\atlas_'+cid1+'_'+ra_radio1+'_'+dec_radio1+'.con'
    postage_stamp_filename1='d:\\ecdfs\\dr3\\atlas_'+cid1+'.jpeg'
    
    cmd1='ds9 -zscale -invert '+radio_image_fits+' -crop '+ra_radio1+' '+dec_radio1+ \
         ' 100 100 wcs fk5 arcsec -contour open -contour loadlevels contour_20mjy.lev -contour yes ' + \
...
#    print cmd1
    ...
    postage_stamp_filename='d:\\ecdfs\\dr3\\'+cid1+'_'+swire_id+'_'+ra_radio1+'_'+dec_radio1+'.jpeg'
