...
CREATE TABLE `swire` (
  ...
  `Index_Optical_Extra` smallint(6) DEFAULT NULL,
  `RA_Optical_Extra` double DEFAULT NULL,
  `Dec_Optical_Extra` double DEFAULT NULL,
  `Index_NIR_2MASS` smallint(6) DEFAULT NULL,
  ...
  `r_AB_mag_Error_Extra` float DEFAULT NULL,
  `i_AB_mag_Error_Extra` float DEFAULT NULL,
  ...
  `MIPS_24_micron_Flux_Error_muJy` double DEFAULT NULL,
  ...
  `MIPS_160_micron_SNR` double DEFAULT NULL,
  ...
  PRIMARY KEY (`Index_Spitzer`),
  KEY `idx_ra_spitzer` (`RA_Spitzer`),
  KEY `idx_dec_spitzer` (`Dec_Spitzer`)
...
-- Dump completed on 2014-04-07 13:28:01
